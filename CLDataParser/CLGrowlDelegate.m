...
@implementation CLGrowlDelegate
...
-(void)growlNotificationWasClicked:(id)clickContext
{
    ...
    NSLog(@"Should probably implement Regex parsing in growl notifications, huh?" );
    
    //NSString *regex = @"(http|https)://((\\w)*|([0-9]*)|([-|_])*)+([\\.|/]((\\w)*|([0-9]*)|([-|_])*))+";
    
    //NSLog(@"%@", [clickContext stringByMatching:regex] );
